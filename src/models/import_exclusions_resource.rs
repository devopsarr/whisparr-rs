...
pub struct ImportExclusionsResource {
    ...
    pub presets: Option<Option<Vec<models::ImportExclusionsResource>>>,
...
impl ImportExclusionsResource {
    pub fn new() -> ImportExclusionsResource {
